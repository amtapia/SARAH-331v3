(* SARAH generated template for parameters.m file for 331v3*)
...
{ZW,{ 
     ...
     Dependence -> {{1/Sqrt[2], 1/Sqrt[2], 0, 0}, {(-I)/Sqrt[2], I/Sqrt[2], 0, 0}, {0, 0, -(1/Sqrt[2]), -(1/Sqrt[2])}, {0, 0, I/Sqrt[2], (-I)/Sqrt[2]}}, 
     DependenceNum -> None, 
     DependenceOptional -> None, 
     DependenceSPheno -> None, 
     Real -> False, 
